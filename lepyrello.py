...
def main():
    parser = argparse.ArgumentParser(description='converts audio files with id3 movement and\
                                     track tag to audio files with id3 track tag only')
    parser.add_argument('-d', dest='directory', help='directory containing the files')
